        ...
        try {
            ...
            while (true) {
                ...
                switch (solicitud[0]) {
                    ...
                    case "2":
                        try {
                            ...
                            out.writeUTF(miBanco.modificarCuenta(Integer.parseInt(solicitud[1]), solicitud[2], solicitud[3], solicitud[4]) ? "Modificación exitosa" : "Error desconocido en la operación");
                        } catch (Exception e) {
                            out.writeUTF("Error --> " + e);
                        }
                        break;
                    ...
                    case "3":
                        try {
                            ...
                            out.writeUTF(miBanco.cerrarCuenta(Integer.parseInt(solicitud[1]), solicitud[2], Integer.parseInt(solicitud[3])) ? "Cancelación de cuenta exitosa" : "Error desconoscido en la operación");
                        } catch (Exception e) {
                            out.writeUTF("Error --> " + e);
                        }
                        break;
                    ...
                    case "4":
                        try {
                            ...
                            out.writeUTF((resultado > -1) ? "Consignación exitosa \n su saldo actual es: " + resultado : "Error en la operación");
                        } catch (Exception e) {
                            out.writeUTF("Error --> " + e);
                        }
                        break;
                    ...
                    case "5":
                        try {
                            ...
                            out.writeUTF((resultado > -1) ? "Tranferencia exitosa \n ahora el remitente tiene: " + resultado : "Error en la operación");
                        } catch (Exception e) {
                            out.writeUTF("Error --> " + e);
                        }
                        break;
                ...
                try {
                    ...
                    out.writeUTF("¡Error! no se ha interpretado la solicitud \n"
                            + "Debido a que no ha ingresado un número: \n" + e);
                }
                //Cierro el socket
